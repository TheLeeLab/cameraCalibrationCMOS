...
**Tip 4:** The brightness of your lamp should be constant during each stack. If your lamp is unstable or has a fluctuating brightness, this will mess up the calibration. Be careful with LED light sources as these switch on and off very fast (imperceptible by eye). [Diekmann *et al.*](https://doi.org/10.1038/s41598-017-14762-6) used a TN-LED laptop screen as a light source.
